...
python main.py --config config/config.yaml --model ast_small --batch-size 64
...
python main.py --config config/iemocap.yaml --model ast_base --batch-size 64

python main.py --config config/iemocap.yaml --model mlp --batch-size 128 & python main.py --config config/iemocap.yaml --model shallow_cnn --batch-size 128 & python main.py --config config/iemocap.yaml --model resnet18 --batch-size 128 & python main.py --config config/iemocap.yaml --model ast_base --batch-size 64
```
- 预期图表
...
python main.py --config config/config.yaml --model ast_small
  ...
  esc50:
    ...
    groups:
      - name: natural_soundscapes
        categories: [rain, sea_waves, crickets, chirping_birds, wind, frog, thunderstorm, water_drops, crackling_fire, insects]
```
- 命令（以 Ravdess+ResNet18 为例，四次分别改 snr_db_choices）
```bash
python main.py --config config/config.yaml --model resnet18
...
python main.py --config config/iemocap.yaml --model ast_small
python main.py --config config/iemocap.yaml --model resnet18
