...
\begin{figure}[htbp]
  ...
  \label{fig:mel_vis_2}
  \includegraphics[width=.8\textwidth]
  {Figures/mfcc_vis/IEMOCAP_Ses01F_impro05_mel.png}
  % mode=image 仅用已编译图；mode=buildmissing 若缺失则自动构建
\end{figure}
...
\begin{figure}[htbp]
  ...
  \includegraphics[width=.8\textwidth]{Figures/mfcc_vis/03-01-02-01-01-02-02_esc50-chirping_birds_p0.70_snr5.0_seed0.png}
  % mode=image 仅用已编译图；mode=buildmissing 若缺失则自动构建
\end{figure}
