...
We adopt a feed-forward multilayer perceptron (MLP, as shown in Figure \ref{fig:mlp arch}) as a lightweight baseline operating on MFCC-based utterance vectors. Given input \(\bar{\mathbf{z}}\) from (\ref{eq:meanpool}), a depth-\(L\) MLP computes
